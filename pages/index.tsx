        ...
        <section>
          ...
          <div className="flex flex-col gap-10 lg:flex-row lg:flex-wrap">
            ...
            <div className="basis-1/3 flex-1">
              ...
              <a href="https://github.com/Kavishathejan/mental_health_mobile_app.git" target="_blank">
                <div className="w-72 h-72 mx-auto"> {/* Uniform width and height */}
                  <Image
                    src={mental}
            ...
            <div className="basis-1/3 flex-1">
              ...
              <a href="https://github.com/Kavishathejan/smart_home_system.git" target="_blank">
                <div className="w-72 h-72 mx-auto"> {/* Uniform width and height */}
                  <Image
                    src={shome}
              ...
              <a href="https://github.com/Kavishathejan/SOS_emergency_app.git" target="_blank">
                <div className="w-72 h-72 mx-auto"> {/* Uniform width and height */}
                  <Image
                    src={sos}
                    alt="SOS emergency alert app"
                    className="rounded-lg object-cover"
                    layout="responsive"
                    width={400}   
                    height={400}  
